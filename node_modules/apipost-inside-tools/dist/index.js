    ...
    try {
        ...
        if (har.hasOwnProperty('postData') && har.postData instanceof Object) {
            if (har.postData.hasOwnProperty('mimeType')) {
                var apipostMode = MODE[har.postData.mimeType] || 'none';
...
var importSwaggerHandle = function (data) { return __awaiter(void 0, void 0, void 0, function () {
    var swaggerApis, localApis, auto_import_id, import_folder_id, import_project_id, cover_modal, handleCoverData, folder_id, project_id, localArr, folderObj, newLocalArr, newApis, localPathObj, localDataObj_1, newApisDataObj_1, saveList_1, index, item, parent_1, localObjItem, _i, localObjItem_1, id, newobj, localObjItem, _a, localObjItem_2, id, pushObj, parent_2, delIds, normalList, normalImportIds_1, saveObj_1, newList_1, sortIds, lastIndex, secIndex;
    var _b;
    var _c, _d, _e, _f, _g;
    return __generator(this, function (_h) {
        switch (_h.label) {
            case 0:
                swaggerApis = data.swaggerApis, localApis = data.localApis, auto_import_id = data.auto_import_id, import_folder_id = data.import_folder_id, import_project_id = data.import_project_id, cover_modal = data.cover_modal, handleCoverData = data.handleCoverData;
            ...
            case 3:
                ...
                if (!(((_c = localDataObj_1[id]) === null || _c === void 0 ? void 0 : _c.auto_import_id) === auto_import_id)) return [3 /*break*/, 5];
            ...
            case 7:
                ...
                _a = 0, localObjItem_2 = localObjItem;
                _h.label = 8;
            case 8:
                if (!(_a < localObjItem_2.length)) return [3 /*break*/, 11];
                id = localObjItem_2[_a];
                if (!lodash.isPlainObject(localDataObj_1[id])) {
                    return [3 /*break*/, 10];
                }
                return [4 /*yield*/, handleCoverData(item, localDataObj_1[id], cover_modal)];
            case 9:
                ...
                // 同url覆盖
                if (cover_modal === 'url') {
                    if (((_d = localDataObj_1[id]) === null || _d === void 0 ? void 0 : _d.auto_import_id) === auto_import_id) {
                    ...
                    // 不覆盖，直接跳过
                    if (((_e = localDataObj_1[id]) === null || _e === void 0 ? void 0 : _e.auto_import_id) === auto_import_id) {
                        saveList_1.push(pushObj);
                    }
                }
                else if (cover_modal === 'bothUrl') {
                    // 保留二者
                    if (((_f = localDataObj_1[id]) === null || _f === void 0 ? void 0 : _f.auto_import_id) === auto_import_id) {
                        saveList_1.push(pushObj);
                    ...
                    if (localDataObj_1.hasOwnProperty(id) &&
                        ((_g = localDataObj_1[id]) === null || _g === void 0 ? void 0 : _g.auto_import_id) === auto_import_id) {
                        // 合并本地和导入的请求区数据
                        saveList_1.push(pushObj);
                    }
                }
        ...
        for (var _i = 0, arr_1 = arr; _i < arr_1.length; _i++) {
            ...
            if (lodash.isString(item === null || item === void 0 ? void 0 : item.key) &&
                ...
                pathItem.parameters.push({
                    ...
                    required: Boolean(item === null || item === void 0 ? void 0 : item.not_null),
                ...
                if (lodash.isPlainObject(value_1) && !lodash.isEmpty(value_1)) {
                    ...
                    if (refArr.length > 1) {
                        ...
                        refArr.forEach(function (item) {
                            ...
                            var modelName = modelObjItem === null || modelObjItem === void 0 ? void 0 : modelObjItem.name;
                            modelObj.properties[modelName] = {
                                $ref: modelPath_1,
                            };
                        });
                    }
                        ...
                        var modelPath_2 = splicedPath((_b = modelsObj === null || modelsObj === void 0 ? void 0 : modelsObj[oldRef]) === null || _b === void 0 ? void 0 : _b.modelPath, version);
                        if (lonely) {
...
var array2NamePathObj = function (items, idName, pidName, modelsObj, version) {
    ...
    try {
        ...
        for (var _i = 0, items_1 = items; _i < items_1.length; _i++) {
            ...
            if (item.target_type == 'api') {
                ...
                if (!paths[temp_url].hasOwnProperty(item === null || item === void 0 ? void 0 : item.method)) {
                    var pathItem = {
                        summary: (item === null || item === void 0 ? void 0 : item.name) || '',
                        description: ((_b = item === null || item === void 0 ? void 0 : item.request) === null || _b === void 0 ? void 0 : _b.description) || '',
                        tags: [],
                    };
                    handlePathItemParameters('query', ((_c = item === null || item === void 0 ? void 0 : item.request) === null || _c === void 0 ? void 0 : _c.query) || [], pathItem);
                    handlePathItemParameters('header', ((_d = item === null || item === void 0 ? void 0 : item.request) === null || _d === void 0 ? void 0 : _d.header) || [], pathItem);
                    handlePathItemrequestBody(((_e = item === null || item === void 0 ? void 0 : item.request) === null || _e === void 0 ? void 0 : _e.body) || {}, pathItem);
                    pathItem.requestBody = deepHandleModelRef(pathItem.requestBody, modelsObj, version);
                    if (path && path.length > 0) {
                        pathItem.tags.push(path);
                    }
                    paths[temp_url][item === null || item === void 0 ? void 0 : item.method] = pathItem;
                }
                else if (path && path.length > 0) {
                    (_f = paths[temp_url][item === null || item === void 0 ? void 0 : item.method]) === null || _f === void 0 ? void 0 : _f.tags.push(path);
                }
...
var array2TreeExport = function (items, idName, pidName, exportApipostObj, version, modelsObj) {
    ...
    if (pidName === void 0) { pidName = 'pid'; }
    try {
        var _a = array2NamePathObj(items, idName, pidName, modelsObj, version), paths = _a.paths, folderObj = _a.folderObj;
...
var apipost2exportSwagger = function (apipostObj, version) {
    ...
    try {
        ...
        if ("".concat(version) === 'metersphere') {
            ...
            console.log('apipost2exportApipost-result', JSON.stringify(result, null, '\t'));
        }
        return result;
    }
    catch (error) {
